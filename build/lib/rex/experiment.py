...
class Experiment:
    ...
    def __init__(self,
        ...
        # Construct filenames
        path = os.path.dirname(xlfile) + '/' + self._sh.lower()
        self._ascii_file = path + '/data/' + self._row[txt_col]
        self._fig_dir = path + '/figures/'
        self._pick_file = path + '/data/' + ('%02d-' % prompt) + os.path.splitext(self._row[txt_col])[0] + '.p'
