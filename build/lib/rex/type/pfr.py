...
class PFR(Experiment):
    ...
    def __init__(self,
        ...
        self._raw_columns = {'time:sec' : [3, 'Time / s'],
                'raw:he' : [4,'He Concentration / mol %'],
                'raw:h2o' : [5, 'H$_2$O Concentration / mol %'],
                'raw:co2' : [6, 'CO$_2$ Concentration / mol %'],
    ...
    def get_temp(self):
        ...
        if TDes > TAds + 10:
            ...
            t = []
            for time in self._curves['time:sec']:
                if time > ramp_time:
            ...
            self._curves.add('temp', t, 'Temperature [C]')
    ...
    def get_flux(self):
        ...
        Flows = [FlowIn*0.9, FlowRxn, FlowRxn]
        ...
        for i, stage in enumerate(stages):
            ...
            # determine equilibrium water value
            co2_init = co2[:2].mean()
